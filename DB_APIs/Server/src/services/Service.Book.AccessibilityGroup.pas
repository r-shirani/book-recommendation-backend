...
End;
//______________________________________________________________________________
procedure TAccessibilityGroupService.Update(const aAccessibilityGroupID: Int64;
...
begin
    ...
    Try
        For I := 0 to Length(aUserIDList) - 1 do
        Begin
        ...
        Begin
            ...
            Try
                lAccessDetail.AccessibilityGroupID := aAccessibilityGroupID;
...
begin
    ...
    For I := 0 to Length(aUserIDList) - 1 do
    Begin
        lAccessDetail := TMVCActiveRecord.GetOneByWhere<TAccessibilityDetail>('AccessibilityGroupID = ? AND UserID = ?', [aAccessibilityGroupID, aUserIDList[I]]);
        lAccessDetail.Delete();
        lAccessDetail.Free;
    End;
End;
//______________________________________________________________________________
