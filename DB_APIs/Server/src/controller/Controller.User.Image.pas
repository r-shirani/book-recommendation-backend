...
Type
    ...
    Public
        ...
        Procedure UpdateImage([MVCFromQueryString('id', '0')] ID: Int64);

        [MVCPath('')]
        [MVCHTTPMethod([httpDELETE])]
        Procedure DeleteImage([MVCFromQueryString('id', '0')] ID: Int64);

        [MVCPath('/file')]
        [MVCHTTPMethod([httpGET])]
        Procedure GetImageFileByGUID([MVCFromQueryString('guid', '0')] GUID: TGUID);
    End;
...
End;
//______________________________________________________________________________
Procedure TUserImageController.GetImageFileByGUID(GUID: TGUID);
Var
    LImage: TImage;
