...
Type
    ...
    Public
        ...
        Procedure GetCollectionsUser([MVCFromQueryString('userid', 0)] id: Int64;
          [MVCFromQueryString('summary', 0)] IsSummary: Boolean);
...
End;
//______________________________________________________________________________
Procedure TBookCollectionFullController.GetCollectionsUser(id: Int64; IsSummary: Boolean);
Begin
    //Render(FService.GetAllUserCollection(IsSummary));
End;
//______________________________________________________________________________
